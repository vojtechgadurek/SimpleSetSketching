...
namespace SimpleSetSketching
{
	public static class HashBuffer
	{
		...
		/// <summary>
		/// Returns expression trees that toogles value to to provided table.
		/// </summary>
		/// <typeparam name="TTable"></typeparam> 
		/// <typeparam name="TValue"></typeparam> Type of value to toogle, it is variable in the returned lambda expression tree.
		/// <param name="hashingFunction"></param> Expected to provide hash of the value in the range of the table.
		/// <param name="table"></param> Table to toogle to, it is fixed.
		/// <returns></returns>
		...
		/// <summary>
		/// Returns expression, that toogles a value to provided table n times, where n is number of hashing functions provided.
		/// </summary>
		/// <typeparam name="TTable"></typeparam>
		/// <typeparam name="TValue"></typeparam>
		/// <param name="hashingFunctions"></param> All hashing functions are expected to provide hash of the value in the range of the table.
		/// <param name="table"></param> Table to toogle to, it is fixed.
		/// <returns></returns>
			...
			where TValue : struct
		{
			...
			var valuesToAddParam = Expression.Parameter(typeof(TBuffer), "value");
